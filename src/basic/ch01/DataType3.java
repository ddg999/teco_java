...
public class DataType3 {
	...
	public static void main(String[] args) {
		...
		float floatBox1 = 0.5f; // 4바이트, F 는 접미사 대소문자 상관없음 
		float floatBox2 = 0.5F; // 접미사 대소문자 둘 다 사용 가능 
		
		double doubleBox1 = 0.123;
		double doubleBox2 = 1.12345678;
		// double 은 8byte 크기이다. 실수의 기본 연산단위, 그 이유는
		...
		System.out.println(0.10d); // d는 아무도안씀
